...
import {DndSpellSubschoolStoreEffects} from './effects';
...
@NgModule({
	imports: [
		...
		EffectsModule.forFeature([DndSpellSubschoolStoreEffects]),
	],
	declarations: [],
	providers: [DndSpellSubschoolStoreEffects,
		{
			provide: INJECTION_TOKEN,
			useFactory: (): ActionReducer<State> => featureReducer
		}]
})
export class DndSpellSubschoolStoreModule {
}
