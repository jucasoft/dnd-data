...
import {DndSpellDescriptorStoreEffects} from './effects';
...
@NgModule({
	imports: [
		...
		EffectsModule.forFeature([DndSpellDescriptorStoreEffects]),
	],
	declarations: [],
	providers: [DndSpellDescriptorStoreEffects,
		{
			provide: INJECTION_TOKEN,
			useFactory: (): ActionReducer<State> => featureReducer
		}]
})
export class DndSpellDescriptorStoreModule {
}
