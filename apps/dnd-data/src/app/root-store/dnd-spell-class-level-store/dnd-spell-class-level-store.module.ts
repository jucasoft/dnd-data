...
import {DndSpellClassLevelStoreEffects} from './effects';
...
@NgModule({
	imports: [
		...
		EffectsModule.forFeature([DndSpellClassLevelStoreEffects]),
	],
	declarations: [],
	providers: [DndSpellClassLevelStoreEffects,
		{
			provide: INJECTION_TOKEN,
			useFactory: (): ActionReducer<State> => featureReducer
		}]
})
export class DndSpellClassLevelStoreModule {
}
