...
import {DndRaceSizeStoreEffects} from './effects';
...
@NgModule({
	imports: [
		...
		EffectsModule.forFeature([DndRaceSizeStoreEffects]),
	],
	declarations: [],
	providers: [DndRaceSizeStoreEffects,
		{
			provide: INJECTION_TOKEN,
			useFactory: (): ActionReducer<State> => featureReducer
		}]
})
export class DndRaceSizeStoreModule {
}
