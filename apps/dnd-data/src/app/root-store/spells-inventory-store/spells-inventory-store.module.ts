...
import {SpellsInventoryStoreEffects} from './effects';
...
@NgModule({
	imports: [
		...
		EffectsModule.forFeature([SpellsInventoryStoreEffects]),
	],
	declarations: [],
	providers: [SpellsInventoryStoreEffects,
		{
			provide: INJECTION_TOKEN,
			useFactory: (): ActionReducer<State> => featureReducer
		}]
})
export class SpellsInventoryStoreModule {
}
