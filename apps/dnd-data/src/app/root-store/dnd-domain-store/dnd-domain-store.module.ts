...
import {DndDomainStoreEffects} from './effects';
...
@NgModule({
	imports: [
		...
		EffectsModule.forFeature([DndDomainStoreEffects]),
	],
	declarations: [],
	providers: [DndDomainStoreEffects,
		{
			provide: INJECTION_TOKEN,
			useFactory: (): ActionReducer<State> => featureReducer
		}]
})
export class DndDomainStoreModule {
}
