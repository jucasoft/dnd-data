...
import {DndRulesConditionStoreEffects} from './effects';
...
@NgModule({
	imports: [
		...
		EffectsModule.forFeature([DndRulesConditionStoreEffects]),
	],
	declarations: [],
	providers: [DndRulesConditionStoreEffects,
		{
			provide: INJECTION_TOKEN,
			useFactory: (): ActionReducer<State> => featureReducer
		}]
})
export class DndRulesConditionStoreModule {
}
