...
import {DndSkillVariantStoreEffects} from './effects';
...
@NgModule({
	imports: [
		...
		EffectsModule.forFeature([DndSkillVariantStoreEffects]),
	],
	declarations: [],
	providers: [DndSkillVariantStoreEffects,
		{
			provide: INJECTION_TOKEN,
			useFactory: (): ActionReducer<State> => featureReducer
		}]
})
export class DndSkillVariantStoreModule {
}
