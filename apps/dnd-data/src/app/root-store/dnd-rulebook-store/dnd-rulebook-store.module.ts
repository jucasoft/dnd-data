...
import {DndRulebookStoreEffects} from './effects';
...
@NgModule({
	imports: [
		...
		EffectsModule.forFeature([DndRulebookStoreEffects]),
	],
	declarations: [],
	providers: [DndRulebookStoreEffects,
		{
			provide: INJECTION_TOKEN,
			useFactory: (): ActionReducer<State> => featureReducer
		}]
})
export class DndRulebookStoreModule {
}
