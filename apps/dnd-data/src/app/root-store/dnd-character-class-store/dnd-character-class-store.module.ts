...
import {DndCharacterClassStoreEffects} from './effects';
...
@NgModule({
	imports: [
		...
		EffectsModule.forFeature([DndCharacterClassStoreEffects]),
	],
	declarations: [],
	providers: [DndCharacterClassStoreEffects,
		{
			provide: INJECTION_TOKEN,
			useFactory: (): ActionReducer<State> => featureReducer
		}]
})
export class DndCharacterClassStoreModule {
}
