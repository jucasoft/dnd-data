...
import {DndRaceTypeStoreEffects} from './effects';
...
@NgModule({
	imports: [
		...
		EffectsModule.forFeature([DndRaceTypeStoreEffects]),
	],
	declarations: [],
	providers: [DndRaceTypeStoreEffects,
		{
			provide: INJECTION_TOKEN,
			useFactory: (): ActionReducer<State> => featureReducer
		}]
})
export class DndRaceTypeStoreModule {
}
