...
import {DndLanguageStoreEffects} from './effects';
...
@NgModule({
	imports: [
		...
		EffectsModule.forFeature([DndLanguageStoreEffects]),
	],
	declarations: [],
	providers: [DndLanguageStoreEffects,
		{
			provide: INJECTION_TOKEN,
			useFactory: (): ActionReducer<State> => featureReducer
		}]
})
export class DndLanguageStoreModule {
}
