...
import {DndRaceSpeedStoreEffects} from './effects';
...
@NgModule({
	imports: [
		...
		EffectsModule.forFeature([DndRaceSpeedStoreEffects]),
	],
	declarations: [],
	providers: [DndRaceSpeedStoreEffects,
		{
			provide: INJECTION_TOKEN,
			useFactory: (): ActionReducer<State> => featureReducer
		}]
})
export class DndRaceSpeedStoreModule {
}
