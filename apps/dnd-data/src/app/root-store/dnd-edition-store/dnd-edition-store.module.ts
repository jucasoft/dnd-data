...
import {DndEditionStoreEffects} from './effects';
...
@NgModule({
	imports: [
		...
		EffectsModule.forFeature([DndEditionStoreEffects]),
	],
	declarations: [],
	providers: [DndEditionStoreEffects,
		{
			provide: INJECTION_TOKEN,
			useFactory: (): ActionReducer<State> => featureReducer
		}]
})
export class DndEditionStoreModule {
}
