...
import {SpellBoardStoreEffects} from './effects';
...
@NgModule({
	imports: [
		...
		EffectsModule.forFeature([SpellBoardStoreEffects]),
	],
	declarations: [],
	providers: [SpellBoardStoreEffects,
		{
			provide: INJECTION_TOKEN,
			useFactory: (): ActionReducer<State> => featureReducer
		}]
})
export class SpellBoardStoreModule {
}
