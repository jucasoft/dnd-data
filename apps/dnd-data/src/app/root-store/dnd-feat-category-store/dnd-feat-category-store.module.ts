...
import {DndFeatCategoryStoreEffects} from './effects';
...
@NgModule({
	imports: [
		...
		EffectsModule.forFeature([DndFeatCategoryStoreEffects]),
	],
	declarations: [],
	providers: [DndFeatCategoryStoreEffects,
		{
			provide: INJECTION_TOKEN,
			useFactory: (): ActionReducer<State> => featureReducer
		}]
})
export class DndFeatCategoryStoreModule {
}
