...
import {DndRaceSpeedTypeStoreEffects} from './effects';
...
@NgModule({
	imports: [
		...
		EffectsModule.forFeature([DndRaceSpeedTypeStoreEffects]),
	],
	declarations: [],
	providers: [DndRaceSpeedTypeStoreEffects,
		{
			provide: INJECTION_TOKEN,
			useFactory: (): ActionReducer<State> => featureReducer
		}]
})
export class DndRaceSpeedTypeStoreModule {
}
